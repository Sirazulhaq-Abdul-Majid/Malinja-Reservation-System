  ...
  <div class="content-wrapper">
    <div class="container">
      <section class="features-overview" id="features-section" >
        ...
        <div class="col-12 col-lg-7 grid-margin grid-margin-lg-0" data-aos="fade-right" style="margin-left:225px; margin-top:-80px;">
          <h2>Users View</h2>
</div>

          <h6 class="section-subtitle text-muted">Edit and remove users<br>according to your needs.</h6>
          <input type="text" name="search_text"id="search_text" size="30"  style="text-align:center "placeholder="Search by Student Details" />
        </div>
        <tr border=0 ><td></td><td colspan=5><div id='result'></div> </td></tr>

        <h5><b>Student data</b></h5>
        <div class="d-md-flex justify-content-between">
          ...
          <tr align="left" bgcolor="#f2f2f2">
            <td>
            <table width="100%" align="left" cellpadding="0" cellspacing="0" style="-moz-border-radius:50px;border-collapse: collapse;border: none">
              <tr align="left" bgcolor="#C0C0C0">
                <th width="3%" style=" -moz-border-radius: 5px 0 0 0 ;">No</td>
                <th width="26%">Name</td>       
                <th width="8%">Gender</td>
                <th width="27%">Address</td>
                <th width="9%">Telephone</td>
                <th align="center" style="-moz-border-radius: 0 5px 0 0 ;">Action</td>
          </tr>
          <?php
	  $color="1";
